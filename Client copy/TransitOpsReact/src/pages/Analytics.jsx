...
export default function Analytics() {
  return (
    <PageLayout 
      ...
      action={<button className="flex items-center gap-2 bg-foreground text-background font-bold px-4 py-2.5 text-sm rounded-xl hover:bg-foreground/90 transition-all shadow-md active:scale-95"><Download size={16} /> Export CSV</button>}
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-card border border-border rounded-2xl p-6 shadow-sm">
          ...
          <div className="text-4xl font-black text-foreground mb-2">81.0<span className="text-2xl text-mutedForeground">%</span></div>
