        ...
        >
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="text-center mt-6">
              <span className="text-sm text-mutedForeground">Don't have an account? </span>
              <Link to="/register" className="text-sm text-primary font-bold hover:underline">Register</Link>
            </div>
          </form>
        </motion.div>
      </div>
